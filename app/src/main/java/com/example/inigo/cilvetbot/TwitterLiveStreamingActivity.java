package com.example.inigo.cilvetbot;
...
public class TwitterLiveStreamingActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_twitter_live_streaming);
